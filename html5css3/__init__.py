...
class HTMLTranslator(nodes.NodeVisitor):
    ...
    def starttag(self, node, tagname, suffix='\n', empty=0, **attributes):
        ...
        # XXX MG TODO: make this in start admonition or something
        if classes in ('note', 'tip', 'hint'):
            atts['class'] = 'alert-message block-message info'
        elif classes in ('attention', 'caution', 'important', 'warning'):
            atts['class'] = 'alert-message block-message warning'
        elif classes in ('error', 'danger'):
            atts['class'] = 'alert-message block-message error'
        elif classes:
            atts['class'] = classes
